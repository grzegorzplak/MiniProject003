...
namespace MiniProject003.Controllers
{
    public class NationalitiesController : Controller
    {
        ...
        public NationalitiesController(Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,NationalityName")] Nationality nationality)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NationalityName")] Nationality nationality)
        {
